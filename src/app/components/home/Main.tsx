...
export default function MainPage() {
  ...
  logger(handleMouseEnterControls(), 'ini Comment');
    ...
    <>
      ...
      >
        <motion.div
          ...
          className='box-stroke relative   h-[300px] w-full rounded-[45px] bg-[#F4F7F9]  p-6 md:mb-20 md:w-[300px] dark:border-gray-700 dark:bg-gray-800'
        >
          <div>
        ...
        <motion.div
          className='box-stroke relative mt-8 h-full w-full overflow-hidden rounded-[55px]  bg-[#F4F7F9] p-6 md:h-[400px] md:w-[400px] dark:border-gray-700 dark:bg-gray-800'
